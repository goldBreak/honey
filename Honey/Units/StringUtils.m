...
+ (NSString *)convertNUL:(NSString *)string defaultString:(NSString *)defaultString {
    ...
    if ([string isKindOfClass:[NSNull class]] || [self isNullOrEmpty:string]) {
...
//    CFURLCreateStringByReplacingPercentEscapes(kCFAllocatorDefault, (CFStringRef)jsonString, (CFStringRef)@"!$&'()*+,-./:;=?@_~%#[]");
    
//    NSString *encodedString = (NSString *)CFBridgingRelease(CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault,(CFStringRef)jsonString,(CFStringRef)@"!$&'()*+,-./:;=?@_~%#[]",NULL,kCFStringEncodingUTF8));
